...
<div class="container">
<mvc:form modelAttribute="goal" action="/Appraisal-Management/hr/addgoal">
     <div class="row">
       <div class="col-25">
         <label for="goalName">Goal Name</label>
       </div>
       <div class="col-75">
         <mvc:input path="goalName" placeholder="Required" required="true"/>
       </div>
     </div>
    <div class="row">
       <div class="col-25">
       ...
       <div class="col-75">
         <mvc:input path="goalDescription" placeholder="Required" required="true"/>
       </div>
     </div>
     <div class="row">
       <div class="col-25">
       ...
       <div class="col-75">
         <mvc:input type="number" path="goalDuration" placeholder="Months in between 1 and 12" min="1" max="12" required="true"/>
       </div>
     </div>
     <br>
     <div class="row">
