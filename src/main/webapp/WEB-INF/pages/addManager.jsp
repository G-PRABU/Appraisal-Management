...
function myFunction() {
 ...
 <br><br>
 <div class="container">
   <form:form action="/Appraisal-Management/admin/manager/create" method="post" modelAttribute="manager">
     <div class="row">
       <div class="col-25">
     ...
     <div class="row">
       ...
       <div class="col-75">
         <form:select path="hr.id">
             <c:forEach items="${hrs}" var="hr">
                 <option value="${hr.id}"><c:out value="${hr.name}"/></option>
             </c:forEach>
         </form:select>
       </div>
     </div>  
